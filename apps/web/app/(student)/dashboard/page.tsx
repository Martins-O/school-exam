        ...
        <div className="max-w-7xl mx-auto px-6 h-24 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col border-l border-white/20 pl-4">
              <span className="text-sm font-black uppercase tracking-widest text-jamb-gold">Candidate Portal</span>
          ...
          <div className="flex items-center gap-8">
            <div className="hidden md:flex flex-col items-end">
              ...
              <span className="text-[10px] font-bold text-jamb-gold/80 block uppercase tracking-widest">UTME CANDIDATE</span>
            </div>
            <button 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="mb-10 flex items-center justify-between border-b-2 border-slate-200 pb-6">
              <h1 className="text-2xl font-black text-jamb-green uppercase tracking-tight">Active Assignments</h1>
                  ...
                  <div key={exam.id} className="portal-card p-1 items-stretch group">
                    <div className="bg-white p-8 rounded-lg flex flex-col md:flex-row items-center gap-8">
                      ...
                      <div className="flex-1 text-center md:text-left">
                        <h3 className="text-xl font-black text-slate-800 uppercase tracking-tight mb-2 group-hover:text-jamb-green transition-colors">{exam.title}</h3>
                        ...
                        <div className="flex flex-wrap justify-center md:justify-start gap-4">
                          ...
                          <span className="px-3 py-1 bg-green-50 text-jamb-green rounded-md text-[10px] font-black uppercase tracking-widest border border-green-100">
                      ...
                      <button
                        ...
                        className="w-full md:w-auto px-10 py-4 bg-jamb-green text-white font-black rounded-xl hover:bg-green-800 transition-all shadow-xl shadow-green-900/20 uppercase text-xs tracking-widest"
                      >
                        Launch Test
                      </button>
                    </div>
          ...
          <div className="space-y-8">
            <div className="portal-card p-8 bg-jamb-green text-white relative overflow-hidden">
               <div className="relative z-10">
                <h4 className="font-black uppercase tracking-widest text-xs text-jamb-gold mb-4">Official Warning</h4>
