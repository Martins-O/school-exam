        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/dashboard" className="flex items-center gap-4 group">
            ...
            <span className="text-xl font-black tracking-tight flex items-center gap-2">
              JAMB <span className="text-xs font-bold text-jamb-gold/80 block uppercase tracking-widest border-l border-white/20 pl-4 mt-1">My Transcripts</span>
            </span>
          </Link>
          <div className="flex items-center gap-6">
            <Link href="/dashboard" className="text-[10px] font-black uppercase tracking-widest text-white/80 hover:text-jamb-gold transition-colors">BACK TO DASHBOARD</Link>
            <Link href="/results" className="text-[10px] font-black uppercase tracking-widest text-white/80 hover:text-jamb-gold transition-colors">VIEW RESULTS</Link>
          </div>
        </div>
      </header>
